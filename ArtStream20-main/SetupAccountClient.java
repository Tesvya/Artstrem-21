...
@Override
    public void actionPerformed(ActionEvent e) {
        ...
        if (command.equals("signin")) {
            ...
            try {
                if (usernameFieldSignin.getText().isEmpty() || passwordSignin.isEmpty()) {
                ...
                try(BufferedReader reader = new BufferedReader(new FileReader("clientaccs.txt"))){
                    ...
                    while ((line = reader.readLine()) !=null) {
                        ...
                        if(parts.length == 2) {
                            ...
                            if(storedUsername.equals(usernameFieldSignin.getText()) && storedPassword.equals(passwordSignin)) {
                                isValid = true;
                                break;
                            }
                        }
            ...
            if(isValid) {
                ...
                new Client(usernameFieldSignin.getText(), passwordSignin).displayDashboard();
                setVisible(false);
            }   else {
                throw new Exception("Invalid Credentials");
